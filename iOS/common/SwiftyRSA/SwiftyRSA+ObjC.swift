...
public class _objc_ClearMessage: NSObject, Message, ObjcBridgeable { // swiftlint:disable:this type_name
    ...
    @objc public func verify(with key: _objc_PublicKey, signature: _objc_Signature) throws -> _objc_VerificationResult {
        let isSuccessful = try swiftValue.verify(with: key.swiftValue, signature: signature.swiftValue)
